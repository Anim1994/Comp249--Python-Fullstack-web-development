...
class Level2FunctionalTests(unittest.TestCase):
    ...
    def test_home_page_lists_posts(self):
        ...
        result = self.app.get('/')
        # look for the title of each positions in the returned page
    ...
    def test_position_page(self):
        ...
        after a positions description on the home page,
        I see a page with the full description of the positions at
        the URL /positions/DD where DD is the positions id."""
